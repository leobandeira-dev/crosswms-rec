...
export const volumes_etiqueta = pgTable("volumes_etiqueta", {
  ...
  numero_volume: integer("numero_volume"),
  descricao: varchar("descricao"),
  peso: decimal("peso"),
  peso_kg: varchar("peso_kg"),
  altura_cm: varchar("altura_cm"),
  largura_cm: varchar("largura_cm"),
  comprimento_cm: varchar("comprimento_cm"),
  volume_m3: varchar("volume_m3"),
  dimensoes: varchar("dimensoes"),
  status: varchar("status").default("recebido"),
