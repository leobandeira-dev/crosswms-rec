    ...
    <aside className="w-64 bg-sidebar h-screen flex flex-col fixed left-0 top-0">
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-2">
        ...
        <SubMenu icon={Truck} label="Coletas" defaultOpen={false}>
          <SidebarItem icon={LayoutDashboard} label="Visão Geral" href="/coletas" />
          <SidebarItem icon={ClipboardList} label="Solicitações" href="/coletas/solicitacoes" />
          <SidebarItem icon={Target} label="Aprovações" href="/coletas/aprovacoes" />
          <SidebarItem icon={Truck} label="Alocação de Veículos" href="/coletas/alocacao-veiculos" />
          <SidebarItem icon={MapPin} label="Execução" href="/coletas/execucao" />
        </SubMenu>
        
        {/* Armazenagem Storage Module - Updated */}
        <SubMenu icon={Archive} label="Armazenagem" defaultOpen={false}>
          <SidebarItem icon={Package} label="Recebimento" href="/armazenagem/recebimento" />
          <SidebarItem icon={Box} label="Movimentações" href="/armazenagem/movimentacoes" />
          <SidebarItem icon={Truck} label="Carregamento" href="/armazenagem/carregamento" />
        ...
        <SubMenu icon={FileText} label="Expedição" defaultOpen={false}>
          ...
          <SidebarItem icon={Package} label="Produtos Perigosos" href="/expedicao/produtos-perigosos" />
        </SubMenu>
